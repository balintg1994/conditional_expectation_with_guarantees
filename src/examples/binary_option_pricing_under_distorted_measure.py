...
from src.experiments.binary_option_pricing_under_distorted_measure import (
    BinaryOptionPricingDistortedMeasure,
)
...
def run_experiment(cfg: DictConfig):
    experiment = BinaryOptionPricingDistortedMeasure(
