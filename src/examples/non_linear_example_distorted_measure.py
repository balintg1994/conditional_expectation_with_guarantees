...
from src.experiments.non_polynomial_example_under_distorted_measure import (
    NonPolynomialExampleDistortedMeasure,
)
...
def run_experiment(cfg: DictConfig):
    experiment = NonPolynomialExampleDistortedMeasure(
