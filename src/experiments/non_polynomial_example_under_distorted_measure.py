...
class NonPolynomialExampleDistortedMeasure(BaseExperiment):
    NAME = "five-dimensional non-polynomial example -- distorted marginal distribution for X"
    INPUT_DIM = 5
